...
export function PhonePreview() {
  const t = useTranslations('landing.phonePreview')
        ...
        <div className="overflow-hidden rounded-[1.85rem] border border-white/8 bg-background">
          ...
          <div className="space-y-3 p-4">
            <div className="rounded-2xl border border-border/70 bg-card/80 p-3">
              ...
              <p className="mt-1 text-sm font-semibold tracking-tight">{t('benchProgression')}</p>
              ...
              <p className="mt-2 text-[11px] text-muted-foreground">
                {t('complete', { percent: 72 })}
              </p>
            </div>
            <div className="grid grid-cols-2 gap-2">
              {[
                { labelKey: 'volume' as const, value: '18.2k' },
                { labelKey: 'rpeAvg' as const, value: '7.8' },
              ].map((stat) => (
                <div
                  key={stat.labelKey}
            ...
            <div className="flex items-center gap-2 rounded-xl border border-[oklch(0.52_0.16_25)]/25 bg-[oklch(0.52_0.16_25)]/10 px-3 py-2">
              ...
              <p className="text-[11px] font-medium">{t('recoveryScore')}</p>
            </div>
          </div>
        </div>
      </div>
